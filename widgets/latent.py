...
from splatviz_utils.gui_utils.interface_imgui import LatentSpace, Slider, Combo, InputInt, CheckboxInput, ColorHist, InputTensor
...
class LatentWidget(Widget):
    def __init__(self, viz):
        ...
        self.latent_space_obj_context = LatentSpace(viz, name="latent_context", latent_name="z_context",    add_to_args=True)
        ...
        #self.hair_color_input = InputTensor(viz, "hair_color", [0.0, 0, 0, 0, 0, 0, 0, 0], device="cuda", add_to_args=True)
